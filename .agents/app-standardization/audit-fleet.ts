...
const TEMPLATE_DIR = 'boat-search'
...
const HUB_KEYS: Record<string, string> = {
  CLOUDFLARE_API_TOKEN: 'boat-search',
  CLOUDFLARE_ACCOUNT_ID: 'boat-search',
...
function main() {
  ...
  console.log('         hub=all hub keys are cross-refs to boat-search / narduk-analytics')
  console.log()
}
