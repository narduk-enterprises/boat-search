...
export const inventoryBudgetLinks: BoatBrowseLink[] = [
  {
    ...
    to: makeInventoryResultsRoute({ maxPrice: '25000' }),
  ...
  },
  {
    ...
    to: makeInventoryResultsRoute({ maxPrice: '50000' }),
  ...
  },
  {
    ...
    to: makeInventoryResultsRoute({ maxPrice: '100000' }),
  ...
  },
  {
    ...
    to: makeInventoryResultsRoute({ maxPrice: '250000' }),
...
export const inventoryLocationLinks: BoatBrowseLink[] = [
  {
    ...
    to: makeInventoryResultsRoute({ location: 'FL' }),
  ...
  },
  {
    ...
    to: makeInventoryResultsRoute({ location: 'TX' }),
    icon: 'i-lucide-map-pinned',
    chips: ['Location: TX'],
  },
  {
    ...
    to: makeInventoryResultsRoute({ location: 'CA' }),
    icon: 'i-lucide-map-pinned',
    chips: ['Location: CA'],
  },
  {
    ...
    to: makeInventoryResultsRoute({ location: 'MI' }),
    icon: 'i-lucide-map-pinned',
    chips: ['Location: MI'],
  },
]
...
export function makeInventorySearchLink(make: string): BoatBrowseLink {
  return {
    ...
    to: makeInventoryResultsRoute({ make }),
