 ...
 *
 * Keeps `boat-search` (Level 1 Fleet Hub) in sync with
 * `0_global-canonical-tokens` (Level 0 Canonical Hub).
 *
 * Because Doppler blocks daisy-chaining references, boat-search
 ...
 * into boat-search's dev and prd configs.
 *
 * Usage:
...
console.log(
  DRY_RUN
    ...
    : '🚀 APPLYING changes to boat-search...\n',
)
